...
namespace Hanger51.EditorTools
{
    public static class Hanger51WorldCountrysideVisualUpgrade
    {
        ...
        static TerrainLayer Layer(string name,Texture2D tex,float tile){TerrainLayer l=new TerrainLayer();l.name=name;l.diffuseTexture=tex;l.tileSize=new Vector2(tile,tile);AssetDatabase.CreateAsset(l,Gen+"/Layers/"+name.Replace(" ","_")+".terrainlayer");return l;}
